...
webix.protoUI({
    ...
    type:{
        ...
        style: function (obj, common, marks, config) {
            var result = "";
            if (config && config.item_margin) {
                result = "margin: " + config.item_margin + ";";
            }

            return result;
        },

        templateStart: webix.template('<div webix_f_id="#id#" class="{common.classname()}" style="{common.style()}width:{common.width}px; height:{common.height}px; float:left; overflow:hidden;">'),
