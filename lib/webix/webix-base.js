...
//html helpers
	webix.html={
		...
		getTextHeightSize:function(text, width, line_height = 34){
			var d = webix.html.create("DIV",{"class":"webix_view webix_measure_size "},"");
			d.style.cssText = "width:" + width + "px; line-height:" + line_height + "px; height:1px; visibility:hidden; position:absolute; top:0px; left:0px; word-wrap:break-word; word-break:break-all;";
			document.body.appendChild(d);
